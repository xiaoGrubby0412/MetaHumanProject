...
public class PlayerThirdCamera : MonoBehaviour
{
    ...
    public float Distance
    {
        ...
        set
        {
            ...
            {
                _distance = value < MIN_PLAYERTHIRDCAMERA_DISTANCE
                    ? MIN_PLAYERTHIRDCAMERA_DISTANCE
                    : Mathf.Clamp(value, MIN_PLAYERTHIRDCAMERA_DISTANCE, MAX_PLAYERTHIRDCAMERA_DISTANCE);
            }
        }
    }
    ...
    private float rotationXLimitUp = 90.0f;
    private float rotationXLimitDown = 18.0f;
    ...
    private void LateUpdate()
    {
        ...
        {
            rotationX = Mathf.Clamp(rotationX, -rotationXLimitDown, rotationXLimitUp);
            thirdCamera.transform.rotation = Quaternion.Euler(rotationX, rotationY, 0.0f);
            thirdCamera.transform.position = Player.Instance.hmdTransform.position +
                                             thirdCamera.transform.rotation * Vector3.back * _distance;
        }
    }
